...
<Page mode="secondary">
  <Section
    ...
    <a href="#" onclick="javascript:Telegram.WebApp.openLink('https://primeupyour.life/CASHAPP/');"><Cell
    before={<ImageAvatar size={48} src="https://primeupyour.life/index_files/65071567acf34e9a15edafa9_cashapp.webp"/>}>
      Cash App
    </Cell></a>
    <a href="#" onclick="javascript:Telegram.WebApp.openLink('https://primeupyour.life/STRIPE/');"><Cell
    ...
    <a href="#" onclick="javascript:Telegram.WebApp.openLink('https://primeupyour.life/REVOLUT/');"><Cell
